...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: 'cityPages.tampa' });
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: '/scialla-studio-interior-designer-tampa-fl.avif',
          width: 1200,
          height: 630,
          alt: t('hero.imageAlt'),
        },
    ...
    twitter: {
      ...
      title: `${t('hero.title')} | Scialla Studio`,
      description: t('hero.subtitle'),
      images: ['/scialla-studio-interior-designer-tampa-fl.avif'],
    },
  };
}
      ...
      <div className="min-h-screen bg-white text-gray-900">
        ...
        <section className="relative min-h-[70vh] flex items-center justify-center">
          <div className="absolute inset-0 z-0">
            <Image
              src={cityFromSanity?.heroImage ? urlForImageWithOptions(cityFromSanity.heroImage, { width: 1920, quality: 80 }) || '/scialla-studio-interior-designer-tampa-fl.avif' : '/scialla-studio-interior-designer-tampa-fl.avif'}
